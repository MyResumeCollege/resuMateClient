...
export const Education = () => {
  const [educationPeriods, setEducationPeriods] = useRecoilState<
          ...
          <div className="flex flex-col items-stretch py-2 px-4 bg-[#DBDBDB] rounded-md gap-[10px]">
            ...
            <div className="flex gap-[10px]">
              <TextInput
                ...
                onChange={(newStartDate) =>
                  updateEditedPeriod({
                    startDate: { month: "Jan", year: newStartDate },
                  })
                }
              />
              <TextInput
                ...
                onChange={(newEndDate) =>
                  updateEditedPeriod({
                    endDate: { month: "Apr", year: newEndDate },
                  })
                }
              />
            </div>
            <div className="flex items-center gap-[10px]">
              ...
              <span
                ...
                onClick={() =>
                  updateEditedPeriod({
                    isCurrent: editedEducationPeriod.isCurrent,
                  })
                }
              >
      ...
      >
        ...
        <span className="text-sm opacity-60 ml-[5px]">
          ...
          {!eduPeriod?.isCurrent && (
            <>
              {" "}
              - {eduPeriod.startDate.month} {eduPeriod.endDate.year}
            </>
          )}
          )
        </span>
